        ...
        <div className={classes.wrapper}>
            ...
            <div className={classes.loginSide}>
                <div className={classes.loginSideWrapper}>
                    ...
                    <br/>
                    <Button onClick={handleClickOpenSignUp} style={{marginBottom: 20}} fullWidth variant={'contained'} color={'primary'}>Зарегистрироваться</Button>
                    <Button onClick={handleClickOpenSignIn} fullWidth variant={'outlined'} color={'primary'}>Войти</Button>
                </div>
            </div>
            <ModalBlock
